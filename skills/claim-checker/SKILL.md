...
```json
{"event":"skill.run","skill":"claim-checker","version":"1.0.0","timestamp":"<ISO 8601 now>","harness":"claude-code","outcome":{"category":"<trust score lowercase>","genre":"<genre>","input_length":<chars>,"output_length":<chars>,"signals_detected":<unsupported claim count>}}
```
