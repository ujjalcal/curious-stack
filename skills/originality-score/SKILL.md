...
```json
{"event":"skill.run","skill":"originality-score","version":"1.0.0","timestamp":"<ISO 8601 now>","harness":"claude-code","outcome":{"category":"<originality lowercase>","genre":"<genre>","input_length":<chars>,"output_length":<chars>,"signals_detected":<commodity signal count>}}
```
