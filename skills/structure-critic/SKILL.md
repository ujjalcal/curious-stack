...
```json
{"event":"skill.run","skill":"structure-critic","version":"1.0.0","timestamp":"<ISO 8601 now>","harness":"claude-code","outcome":{"category":"<structure verdict lowercase>","genre":"<genre>","input_length":<chars>,"output_length":<chars>,"signals_detected":<flow break count>}}
```
