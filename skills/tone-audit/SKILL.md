...
```json
{"event":"skill.run","skill":"tone-audit","version":"1.0.0","timestamp":"<ISO 8601 now>","harness":"claude-code","outcome":{"category":"<gap size: none/small/large>","genre":"<genre>","input_length":<chars>,"output_length":<chars>,"signals_detected":<evidence count>}}
```
